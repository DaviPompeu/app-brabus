  ...
  with dm.qryGeral do
    begin
      //SALVANDO OS
        ...
        // Se formataResult = '000001' significa que devemos fazer um insert, pois não existe nenhum campo na TAB_CODIGO
        ...
        begin
             Active := false;
             Sql.Clear;
             SQL.ADD('UPDATE TAB_CODIGO SET CODIGO_OS=:CODIGO_OS'); // Se formataResult <> 00001 significa que na TAB_CODIGO tem um codigo já cadastrado
             ParamByName('CODIGO_OS').Value := formataResult;
             ExecSQL;
        end;
